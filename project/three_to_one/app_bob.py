...
def main(app_config=None):
    ...
    # Create Bob's context, initialize EPR pairs inside it and call Bob's 321 method. Finally, print out whether or not Bob successfully created an EPR Pair with Alice.
    ...
    with bob:
        ...
        dm_result = get_qubit_state(epr3, reduced_dm=False)
        # print(dm_result)
